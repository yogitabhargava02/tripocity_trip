  ...
  <header class="p-3" style="color: black">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <ul class="nav col-12 col-lg-auto me-lg-auto ms-a">
        ...
        <li>
          <a href="./logout/index.php" class="nav-link px-2 text-black">Home</a>
        </li>
        <li>
          <a href="./logout/about.php" class="nav-link px-2 text-black">About us</a>
        </li>

        <li>
          <a href="./logout/Hotels.php" class="nav-link px-2 text-black">Hotels</a>
        </li>
        <li>
          <a href="./logout/TripocityReviews.php" class="nav-link px-2 text-black">Reviews</a>
        </li>
      </ul>
<!-- lohin -->
<div class="wrapper">
            ...
            <div class="nav_right">
                <ul>
                    <li class="nr_li dd_main">
                        <img src="logout/icon.png" width="900px" alt="profile_img">
    ...
    <div class="container-fluid hero_container">
      ...
      <div class="main_form">
        ...
        <form method="post" onsubmit="return redirect()" class= "d-flex flex-row justify-content-between align-items-center" >
          ...
          <p class="or_btn">OR</p>
          <a style=" text-decoration:none;text-align: center;line-height: 30px; background: transparent;" href="./logout/seasons.php">Search by season</a>
  ...
  <div class="container-fluid" style="width: 100%; border-bottom: 2px solid black">
          ...
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="
            ...
            <div class="col p-4 d-flex flex-column position-static">
              ...
              <div class="div" style="position: absolute; bottom: 0">
                ...
                <a href="./seasonsplace/jabalpur.php" class="stretched-link">Read More</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="
            ...
            <div class="col p-4 d-flex flex-column position-static">
              ...
              <div class="div" style="position: absolute; bottom: 0">
                ...
                <p>
                  <a href="./seasonsplace/sanchi.php" class="stretched-link">Read More</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="
            ...
            <div class="col p-4 d-flex flex-column position-static">
              ...
              <div class="div" style="position: absolute; bottom: 0">
                ...
                <a href="./seasonsplace/Ujjain.php" class="stretched-link">Read More</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" style="
            ...
            <div class="col p-4 d-flex flex-column position-static">
              ...
              <div class="div" style="position: absolute; bottom: 0">
                ...
                <a href="./seasonsplace/Gwalior.php" class="stretched-link">Read More</a>
              </div>
            </div>
